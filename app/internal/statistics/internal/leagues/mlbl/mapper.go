...
func (m *mapper) mapGame(game infobasket2.GameBoxScoreResponse, regulationPeriodsNumber int, periodDuration int, overtimeDuration int, leagueAlias string) *models.GameBoxScoreDTO {
	duration := 0
...
func (m *mapper) mapTeam(teamBoxScore infobasket2.TeamBoxScoreDto) models.TeamBoxScoreDTO {
	return models.TeamBoxScoreDTO{
		...
		Players: array_utils.Map(teamBoxScore.Players, func(player infobasket2.PlayerBoxScoreDto) models.PlayerDTO {
			return m.mapPlayer(player)
		}),
	}
}

func (m *mapper) mapPlayer(player infobasket2.PlayerBoxScoreDto) models.PlayerDTO {
