...
func (m *MockmlblMapperInterface) mapGame(game infobasket.GameBoxScoreResponse, regulationPeriodsNumber, periodDuration, overtimeDuration int, leagueAlias string) (*GameBoxScoreDTO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "mapGame", game, regulationPeriodsNumber, periodDuration, overtimeDuration, leagueAlias)
...
func (mr *MockmlblMapperInterfaceMockRecorder) mapGame(game, regulationPeriodsNumber, periodDuration, overtimeDuration, leagueAlias interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mapGame", reflect.TypeOf((*MockmlblMapperInterface)(nil).mapGame), game, regulationPeriodsNumber, periodDuration, overtimeDuration, leagueAlias)
}
